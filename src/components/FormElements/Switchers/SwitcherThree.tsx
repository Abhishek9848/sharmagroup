...
const SwitcherThree = ({ enabled, setEnabled, id }: SwitcherThreeProps) => {
  return (
    <div>
      <label htmlFor={id} className="flex cursor-pointer select-none items-center">
        <div className="relative">
          ...
          {/* Dot */}
          <div
            className={`absolute top-0.5 left-0.5 flex h-5 w-5 
