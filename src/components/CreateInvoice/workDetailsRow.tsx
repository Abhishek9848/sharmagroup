                ...
                <div key={rowIndex} className="mb-8 border-b pb-4">
                    <div key={rowIndex} className="mb-5.5 flex flex-col gap-1.5 sm:flex-row">
                        ...
                        <InputGroup
                            ...
                            height="sm"
                            placeholder=""
                            handleChange={(e) => handleRowChange(rowIndex, "from", e.target.value)}
                        />
                        <InputGroup
                            width="w-25"
                            type="text"
                            ...
                            height="sm"
                            placeholder=""
                            handleChange={(e) => handleRowChange(rowIndex, "to", e.target.value)}
                        />
                        <InputGroup
                            width="w-25"
                            type="text"
                            ...
                            required
                            placeholder=""
                            handleChange={(e) => handleRowChange(rowIndex, "amount", e.target.value)}
                        />
                        <button
                            type="button"
